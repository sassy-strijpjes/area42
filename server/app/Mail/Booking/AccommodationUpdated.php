...
class AccommodationUpdated extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Your accommodation booking has been updated – ' . config('app.name'),
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.booking.accommodation-updated',
            with: [
