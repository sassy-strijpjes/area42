...
class RolePermissionSeeder extends Seeder
{
    ...
    public array $permissions = [
        ...
        'edit_roles',
        'delete_roles',
        'view_accomodation-types',
        'add_accomodation-types',
        'edit_accomodation-types',
        'delete_accomodation-types',
        'view_accomodation-units',
        'add_accomodation-units',
        'edit_accomodation-units',
        'delete_accomodation-units',
