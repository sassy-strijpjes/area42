    ...
    <form wire:submit.prevent="save">
        <div class="space-y-6">
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <flux:select wire:model.live="typeId" label="Accommodation type">
            ...
            <flux:card class="space-y-6">
                ...
                <div class="rounded-lg bg-zinc-50 dark:bg-zinc-800 p-4 space-y-2 text-sm">
                    ...
                    <div class="flex justify-between border-t border-zinc-200 dark:border-zinc-700 pt-2 font-semibold text-base">
